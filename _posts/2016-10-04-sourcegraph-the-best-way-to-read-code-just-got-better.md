...
author: Quinn Slack
redirect_from:
  - /sourcegraph-the-best-way-to-read-code-just-got-better-2094def0e553
---
...
{% include image.html url="/assets/blog-images/1*kqiD7GzlN5OIrZpjYvNiEQ.png" description="Jump to any symbol or file. Activate it with the “/” hotkey." %}
...
{% include image.html url="/assets/blog-images/1*wpxr_W1t4Sc9bypF0nr6yg.png" description="Jump to any repository. Activate it with the “/” hotkey." %}
