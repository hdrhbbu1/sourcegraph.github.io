...
author: Beyang Liu
redirect_from:
  - /google-i-o-talk-building-sourcegraph-a-large-scale-code-search-cross-reference-engine-in-go-1f911b78a82e
---
...
{% include image.html url="/assets/blog-images/0*DJYjK6JTlwcaMvH4.png" description="" %}
...
{% include image.html url="/assets/blog-images/1*M99o63WSIzIzh86uZdTveA.png" description="" %}
