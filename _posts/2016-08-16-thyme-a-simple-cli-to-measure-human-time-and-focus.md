...
author: Beyang Liu
redirect_from:
  - /thyme-a-simple-cli-to-measure-human-time-and-focus-577b87337b9c
---
...
{% include image.html url="/assets/blog-images/1*2v_gWy792Wru6O1MiookSA.png" description="<a href='https://github.com/sourcegraph/thyme'>Thyme</a> is a sampling profiler for your productivity." %}
...
So we wrote [Thyme](https://github.com/sourcegraph/thyme), an [open-source](https://sourcegraph.com/github.com/sourcegraph/thyme/-/def/GoPackage/github.com/sourcegraph/thyme/cmd/thyme/-/main.go/TrackCmd/Execute) command-line tool that lets you easily track and analyze the time you spend on your computer. Think of it as a sampling profiler, but for You instead of your machine.
...
{% include image.html url="/assets/blog-images/1*GFD8duK-0OI6vG1EBvgG6A.png" description="Thyme’s timeline of application usage" %}
...
{% include image.html url="/assets/blog-images/1*xXyBOBL5hHr2ywWpBPNp4w.png" description="“Thyme”-line of application windows" %}
...
{% include image.html url="/assets/blog-images/1*6i1FV6krky_Gyfbk1dMseg.png" description="Aggregate breakdown of which applications were most used, most visible, and most open" %}
