...
redirect_from:
  - /the-sourcegraph-developer-release-a-better-way-to-discover-and-understand-code-f75c298778b5
---
...
{% include image.html url="/assets/blog-images/1*RzHYLrAIuhh8p4xOVnjoSQ.png" description="[On Sourcegraph, everything in code is clickable (jump-to-def) and has doc tooltips. You can understand code more quickly with these.](https://sourcegraph.com/github.com/golang/go/-/def/GoPackage/fmt/-/Fprintf)" %}
...
{% include image.html url="/assets/blog-images/1*e2ecNFlkz80d0tjK2rgpzw.png" description="[At the time this post was published, Fprintf was called in more than 11,000 other projects around the world. See them all!](https://sourcegraph.com/github.com/golang/go/-/info/GoPackage/fmt/-/Fprintf)" %}

**Smart search quickly gets you what you need.** You can search by the name of any function, class, type, etc.

{% include image.html url="/assets/blog-images/1*0r8ZMCWmXNPgCclHae68CQ.png" description="" %}
