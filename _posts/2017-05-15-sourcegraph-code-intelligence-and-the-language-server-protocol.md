...
author: Beyang Liu
redirect_from:
  - /sourcegraph-code-intelligence-and-the-language-server-protocol-f2479fdd92ef
---
...
{% include image.html url="/assets/blog-images/0-dfLDwCJbsrLWI63Q.png" description="An example of the protocol in use, from the <a href='https://github.com/Microsoft/language-server-protocol/blob/master/README.md'>README</a>." %}
...
{% include image.html url="/assets/blog-images/1*ws2LYhzfuHpEimlb9-knWQ.png" description="O(M + N)" %}
