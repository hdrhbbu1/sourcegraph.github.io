...
author: Beyang Liu
redirect_from:
  - /announcing-checkup-simple-self-hosted-health-checks-c5707cf729ab
---
...
{% include image.html url="/assets/blog-images/0*bR4H1dPKkhf6T-hC.png" description="The Checkup status page works out of the box" %}
...
{% include image.html url="/assets/blog-images/0*AEcci4InW9CYuloX.jpg" description="" %}
