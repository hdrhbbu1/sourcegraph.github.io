...
author: Quinn Slack
redirect_from:
  - /the-pain-of-code-review-how-different-teams-manage-scale-and-perform-code-reviews-f9abc79d7f3a
---
...
{% include image.html url="/assets/blog-images/1*0lf5CXM0eXoh-d1syiDPMg.png" description="A typical code review UI (in a GitHub pull request)." %}
