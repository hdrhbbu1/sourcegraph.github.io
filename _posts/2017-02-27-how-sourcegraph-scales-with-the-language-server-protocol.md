...
author: Beyang Liu
redirect_from:
  - /how-sourcegraph-scales-with-the-language-server-protocol-a4e8fd3fbae5
---
...
{% include image.html url="/assets/blog-images/0-dfLDwCJbsrLWI63Q.png" description="An example of the protocol in use, from the <a href='https://github.com/Microsoft/language-server-protocol/blob/master/README.md'>official README</a>." %}
...
{% include image.html url="/assets/blog-images/1*deSfeuQZchkOAbI5v7KKCg.png" description="M x N" %}
...
{% include image.html url="/assets/blog-images/1*ws2LYhzfuHpEimlb9-knWQ.png" description="M + N" %}
